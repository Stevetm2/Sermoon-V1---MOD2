...
#define HOMING_BUMP_DIVISOR { 10, 10, 4 }//{ 2, 2, 4 }       // Re-Bump Speed Divisor (Divides the Homing Feedrate)
 ...
 */
#define LIN_ADVANCE //sjt
#if ENABLED(LIN_ADVANCE)
  //#define EXTRA_LIN_ADVANCE_K // Enable for second linear advance constants
  #define LIN_ADVANCE_K 0.03 //sjt    // Unit: mm compression per 1mm/s extruder speed
  //#define LA_DEBUG            // If enabled, this will generate debug information output over USB.
  #define EXPERIMENTAL_SCURVE //sjt // Enable this option to permit S-Curve Acceleration
#endif
 ...
 */
  ...
  #define MESH_MAX_X 165 - (MESH_INSET)
